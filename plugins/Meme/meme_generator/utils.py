...
def translate(text: str, lang_from: str = "auto", lang_to: str = "zh") -> str:
    ...
    #     "sign": sign,
    # }
    url = f"https://xiaoapi.cn/API/zs_fy.php?type=youdao&to={lang_to}&msg={text}"
    # url = f"https://fanyi-api.baidu.com/api/trans/vip/translate?q={text}&from={lang_from}&to={lang_to}"
